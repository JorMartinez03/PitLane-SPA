export default function CategoryNav({ activeCategory, onSelect, categories = ['F1', 'F2', 'F3'] }) {
  return (
        ...
        return (
          <button
            ...
            className={`
              ...
              rounded-lg transition-all duration-200 cursor-pointer whitespace-nowrap
              ${
                isActive
